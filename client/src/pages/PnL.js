                ...
                <div style={{overflowX: 'auto'}}>
                    <table style={{width: '100%', borderCollapse: 'separate', borderSpacing: '0'}}>
                        ...
                        <tbody>
                            {trades.map(trade => (
                                <tr key={trade._id}>
                                    <td style={{padding: '14px 12px', borderBottom: '1px solid var(--border)'}}>{new Date(trade.date).toLocaleDateString()}</td>
                                    <td style={{padding: '14px 12px', borderBottom: '1px solid var(--border)'}}>
                                        <div style={{fontWeight:'600'}}>{trade.script}</div>
                                        <div style={{fontSize:'0.75rem'}} className="text-muted">{trade.type}</div>
                                    </td>
                                    <td style={{padding: '14px 12px', borderBottom: '1px solid var(--border)'}}>
                                    ...
                                    <td style={{padding: '14px 12px', borderBottom: '1px solid var(--border)', textAlign:'right', fontWeight:'700'}} className={trade.pnl >= 0 ? "text-up" : "text-down"}>
