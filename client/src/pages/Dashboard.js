...
const Dashboard = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                // This talks to your server on port 5000
    ...
    // 2. Calculate Dashboard Numbers on the fly
    ...
    const lineChartData = {
        ...
        datasets: [{
            ...
            data: [500000, 515000, 530000, 520000, 500000 + metrics.totalPnL], // Dynamic last point
            borderColor: '#4f46e5',
